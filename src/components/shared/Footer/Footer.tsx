        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <FooterLink href="/login" label="Login / Dashboard" />
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4">
              <FooterLink href="/products?category=Smart+Gadgets" label="Smart Gadgets" />
              <FooterLink href="/products?category=Audio" label="Audio" />
              <FooterLink href="/products?category=Gaming" label="Gaming" />
              <FooterLink href="/products?category=Smart+Home" label="Smart Home" />
