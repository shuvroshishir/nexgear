    ...
    >
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-muted-foreground text-sm max-w-sm">
          Sign up to get started with NexGear
        </p>
      </div>
      ...
      <div className="grid gap-5">
        <div className="grid gap-2">
          ...
          <div className="relative">
            <User className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-muted-foreground/70" />
            <Input
              value={name}
      ...
      <div className="text-center text-sm text-muted-foreground mt-2">
        ...
        <Link href="/login" className="text-primary hover:text-emerald-500 font-semibold transition-colors">
          Login here
        </Link>
      </div>
    </motion.form>
